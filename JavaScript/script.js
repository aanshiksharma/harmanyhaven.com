...
Array.from(cards).forEach(element => {
    ...
    for (let i = 0; i <= index; i++){
        if (i == index) {
            ...
            else if (i === 1) link = 'harmony-haven/' + htmlLinks.card2;
            else if (i === 2) link = 'harmony-haven/' + htmlLinks.card3;
            else if (i === 3) link = 'harmony-haven/' + htmlLinks.card4;
            else if (i === 4) link = 'harmony-haven/' + htmlLinks.card5;
            else if (i === 5) link = 'harmony-haven/' + htmlLinks.card6;
            else if (i === 6) link = 'harmony-haven/' + htmlLinks.card7;
            else if (i === 7) link = 'harmony-haven/' + htmlLinks.card8;
            else if (i === 8) link = 'harmony-haven/' + htmlLinks.card9;
            else if (i === 9) link = 'harmony-haven/' + htmlLinks.card10;
        }
    }
